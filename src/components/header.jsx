    ...
    <header className="fixed top-0 left-0 w-full h-16 md:h-20 bg-white shadow-md z-10">
      <div className="h-full px-4 md:px-12 flex items-center">
        ...
        <div className="relative flex items-center justify-between w-full md:hidden">
          ...
          <Link to="/login" className="text-xs font-bold bg-orange-400 rounded-full px-3 py-1.5 text-white">Login</Link>
        </div>
        ...
        <div className="hidden md:flex items-center gap-6 w-full">
          ...
          <Link to="/login" className="flex items-center gap-2 bg-gray-200 rounded-full px-4 py-2 hover:bg-gray-300">
